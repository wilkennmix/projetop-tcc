...
<body>
  ...
  <main>
    <section class="menu">
      <a href="cadastro.php"><button type="button" class="btn">Cadastro de cliente</button></a>
      ...
      <a href="produtos.php"><button type="button" class="btn">Cadastro de produto</button></a>
      <a href="sistema.php"><button type="button" class="btn">Lista de produto</button></a>
